...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query to check if the faculty ID exists in the database
...
<head>
    ...
    <title>Faculty Login - FaculTrack</title>
...
<body>
    ...
    <div class="login-container">
        ...
        <form class="login-form" action="faclogin.php" method="POST">
            <input type="text" name="facultyID" placeholder="Faculty ID" required>
            <input type="password" name="password" placeholder="Password" required>
            <input type="hidden" id="total-score" name="total_score">
            <input type="hidden" id="grade" name="grade">
            <input type="hidden" id="allowance" name="allowance">
            <br>
        ...
        <div class="instructions">
            <h3>Instructions:</h3>
            <ul>
                <li>This is the Faculty Login page for FaculTrack.</li>
                <li>Enter your Faculty ID and Password to access your dashboard.</li>
                <li>If you are a new faculty member, please use the "Sign-Up" link to create an account.</li>
                <li>If you've forgotten your password, use the "Forgot Password?" link to reset it.</li>
                <li>Ensure that you keep your login credentials confidential for security purposes.</li>
            </ul>
        </div>
    </div>
<br>
